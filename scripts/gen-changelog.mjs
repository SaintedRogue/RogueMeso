...
//
//   node scripts/gen-changelog.mjs   (or: npm run gen:changelog)
//
...
writeFileSync("changelog.json", JSON.stringify(out) + "\n");
console.log(`gen-changelog: wrote ${commits.length} commits to changelog.json`);
